...
3. Open Whisper Systems. (2016). Signal Protocol Technical Documentation. Retrieved from signals.org/docs/
...
5. WhatsApp. (2023). WhatsApp Encryption Overview: Technical White Paper. Meta Platforms, Inc. Retrieved from whatsapp.com/security/

6. Facebook Engineering. (2020). Compact Key Storage: Keeping secrets safe and accessible. Retrieved from engineering.fb.com/security/compact-key-storage/
...
8. Marlinspike, M. (2016). Forward Secrecy for Asynchronous Messages. Signal Blog. Retrieved from signal.org/blog/asynchronous-security/

9. Krawczyk, H., & Eronen, P. (2010). HMAC-based Extract-and-Expand Key Derivation Function (HKDF). IETF RFC 5869.

10. WhatsApp Help Center. (2024). About End-to-End Encryption. Retrieved from faq.whatsapp.com/general/security-and-privacy/end-to-end-encryption
